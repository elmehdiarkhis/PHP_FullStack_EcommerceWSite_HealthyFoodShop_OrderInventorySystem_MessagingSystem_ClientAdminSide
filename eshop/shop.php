...
<section class="p-category">
   ...
   <a href="category.php?category=vegitables">legumes</a>
   <a href="category.php?category=fish">poissons</a>
   <a href="category.php?category=meat">viandes</a>

</section>

<section class="products">

   <h1 class="title">Dernier produit ajouter</h1>

   <div class="box-container">


   <!-- RECUPERER TOUT LES PRODUIT ET LES AFFICHER -->
   <?php
   ...
   ?>
      ...
      <!-- AFFICHER LES INFOS DU PRODUIT -->
         ...
         <!-- HIDDEN INPUT POUR PASSER LES INFORMATIONS -->
   ...
   <?php
      ...
      echo '<p class="empty">pas de produit ajouter pour l instant!</p>';
   }
   ?>
